...
# Script to run DLinear on PEMS07 with L=36 and H in {12,24,36,48}
...
echo "DLinear PEMS07 downstream finetune" > "$SUMMARY_FILE"
...
echo "Starting DLinear PEMS07 runs..." | tee -a "$SUMMARY_FILE"
...
echo "DLinear PEMS07 script finished." | tee -a "$SUMMARY_FILE"
