...
# Script to run DLinear on PEMS08 with L=36 and H in {12,24,36,48}
...
echo "DLinear PEMS08 downstream finetune" > "$SUMMARY_FILE"
...
echo "Starting DLinear PEMS08 runs..." | tee -a "$SUMMARY_FILE"
...
echo "DLinear PEMS08 script finished." | tee -a "$SUMMARY_FILE"
