...
# Script to run DLinear on PEMS03 with L=36 and H in {12,24,36,48}
...
echo "DLinear PEMS03 downstream finetune" > "$SUMMARY_FILE"
...
echo "Starting DLinear PEMS03 runs..." | tee -a "$SUMMARY_FILE"
...
echo "DLinear PEMS03 script finished." | tee -a "$SUMMARY_FILE"
