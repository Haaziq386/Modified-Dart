...
# Best HTULTS config from latest summary: outputs/test_results/htults_grid_Weather_20260419_064728/summary.txt
# Dataset=Weather, pred_len=720
...
python -u run.py \
  ...
  --use_cpc "1" \
  --cpc_lambda "1" \
  --cpc_freq_mask_ratio "1" \
  --cpc_time_mask_ratio "0.7" \
