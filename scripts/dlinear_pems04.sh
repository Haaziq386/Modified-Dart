...
# Script to run DLinear on PEMS04 with L=36 and H in {12,24,36,48}
...
echo "DLinear PEMS04 downstream finetune" > "$SUMMARY_FILE"
...
echo "Starting DLinear PEMS04 runs..." | tee -a "$SUMMARY_FILE"
...
echo "DLinear PEMS04 script finished." | tee -a "$SUMMARY_FILE"
